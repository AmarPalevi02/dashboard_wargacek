...
const ManageDInas: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 sm:py-6 md:py-8">
      <div className="w-full px-3 xs:px-4 sm:px-5 md:px-6 lg:px-8 max-w-full md:max-w-5xl lg:max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-6 sm:mb-8">
          <h1 className="text-xl xs:text-2xl sm:text-3xl font-bold text-gray-900">
            Management Dinas
          </h1>
          <p className="mt-1 sm:mt-2 text-xs xs:text-sm text-gray-600">
            Kelola data dinas dan pengguna yang terkait
          </p>
        </div>
              ...
              <div className="px-4 sm:px-5 md:px-6 py-3 sm:py-4 border-b border-gray-200">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0">
                  ...
                  <div className="flex flex-col xs:flex-row items-stretch xs:items-center gap-2 sm:gap-3 w-full sm:w-auto">
                    <Button
                      onClick={() => setShowCreateForm(true)}
                      className="inline-flex items-center justify-center px-3 sm:px-4 py-2 border border-transparent rounded-md shadow-sm text-xs sm:text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 w-full xs:w-auto"
                    >
                      <svg
                      ...
                      <span className="whitespace-nowrap">Tambah User</span>
                    </Button>
                    <button
                      onClick={() => refetch()}
                      className="inline-flex items-center justify-center px-3 sm:px-4 py-2 border border-gray-300 rounded-md shadow-sm text-xs sm:text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 w-full xs:w-auto"
                    >
                      <svg
                        className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2"
                        fill="none"
